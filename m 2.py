...
API_TOKEN = '7502536798:AAEHbSGe7HrJrYOajucbBbygs4d8Jft84u0'
...
async def user_info(message: Message):
    ...
    if user_data:
        ...
        approval_expiry_str = "𝙊pps 𝙉ot 𝙖pproved 𝘾ontасt @MENTALDC2018"
